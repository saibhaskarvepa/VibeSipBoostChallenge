...
export default function Hero() {
  return (
    <section id="home" className="relative w-full overflow-hidden pt-20 md:pt-32 lg:pt-40 pb-10 md:pb-16 bg-background">
      <div className="absolute inset-0 z-0 opacity-20">
        ...
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-y-0 left-0 w-1/2 animate-flow-left-to-right">
            <div className="h-full w-full bg-gradient-to-r from-primary/10 via-accent/5 to-transparent opacity-50"></div>
          </div>
          <div className="absolute inset-y-0 right-0 w-1/2 animate-flow-right-to-left">
            <div className="h-full w-full bg-gradient-to-l from-accent/10 via-primary/5 to-transparent opacity-50"></div>
          </div>
        </div>
      </div>
